...
.popup add command -label Refresh -underline 0 -command Refresh
.popup add separator 
.popup add command -label Home -underline 1 -command \
                                      {LoadFile [lindex $PrevFiles 0]}
.popup add command -label Back -underline 1 -command \
                                      {LoadFile [lindex $PrevFiles end]}
.popup add command -label Forward -underline 1 -command \
          {LoadFile [lindex $NextFiles 0]}
