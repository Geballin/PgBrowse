...
if {[info command html]==""} {
  if {![package require Tkhtml]} exit
}
...
# This routine is called for Font info
proc FntCmd { size attr } {
  puts "Size: $size Attri: $attr"
  if { $attr == "fixed"} {return "courier [incr size 5]"}
  return {}
}
